    ...
    <body class="ttr-opened-sidebar ttr-pinned-sidebar">
        ...
        <main class="ttr-wrapper">
            <div class="db-breadcrumb" style="display: flex; justify-content: center;">
                <h4 >PO List Management</h4>
            </div>

            <div class="mb-4 ml-5">
                <form action="${pageContext.request.contextPath}/FLM/polist" method="post">                                      
                ...
                <table class="table table-bordered mb-5">
                    <thead class="table-warning">
                        <tr>
                            ...
                            <th scope="col" data-sort-order="asc" id="po-id-header">PO ID</th>
                        ...
                        <c:otherwise>
                            <c:forEach items="${list}" var="s" varStatus="index"> 
                                <tr class="numrow">
                                    ...
                                    <th>${s.getPoId()}</th>
                                    <td>${s.getPoName()}</td>
                                    <td>${s.getPoDecription()}</td>
                                    <td>${s.getCurriculum().getCurriculumCode()}</td>
                                    <td>
                                        <button
                                            type="button"
                                            ...
                                            >
                                            <a href="poedit?poid1=${s.getPoId()}"> <i class="fa fa-edit"></i></a>
                                        </button>
                                    </td>
                                </tr>
                            </c:forEach>
