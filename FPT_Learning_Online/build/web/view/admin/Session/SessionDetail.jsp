...
<html>
    ...
    <body class="ttr-opened-sidebar ttr-pinned-sidebar">
        ...
        <main class="ttr-wrapper">
                    ...
                    <input type="hidden" id="show" value="fgs">
...
<!--                                    <input type="text" name="id" value="${decision.decisionID}" hidden="">-->
                                    <div class="row">
                                        <div class="form-group col-6">
                                            ...
                                            <div>
                                                <input class="form-control" type="text" name="sessionno" value="${s.getSessionno()}" required>
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <div>
                                                <input class="form-control" type="text" name="topic" value="${s.getTopic()}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <div>
                                                <input class="form-control" type="text" name="type" value="${s.getLearntype()}"required>
                                            </div>
                                        </div> 
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <div>
                                                <input class="form-control" type="text" name="itu" value="${s.getItu()}">
                                            </div>
                                        </div>    
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <div>
                                                <input class="form-control" type="text" name="material" value="${s.getMaterial()}" required>
                                            </div>
                                        </div>   
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <div>
                                                <input class="form-control" type="text" name="down" value="${s.getDown()}">
                                            </div>
                                        </div>  
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <div>
                                                <input class="form-control" type="text" name="task" value="${s.getTask()}" required>
                                            </div>
                                        </div>    
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <div>
                                                <input class="form-control" type="text" name="url" value="${s.getUrl()}">
                                            </div>
                                        </div>    
