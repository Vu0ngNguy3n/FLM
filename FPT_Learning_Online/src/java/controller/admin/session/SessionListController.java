 ...
 * @author bongt
 */
@WebServlet(name="SessionListController", urlPatterns={"/FLM/sessionlist"})
public class SessionListController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        System.out.println(request.getParameter("txt")==null ?"null search":"ko null searh");
        System.out.println(txt==null?"null roi":"rong thoi");
        System.out.println("txt"+txt);
        SyllabusDBContext db = new SyllabusDBContext();
        List<SessionList> seslist =db.getAllSessionList(txt);
        request.setAttribute("seslist", seslist);
        request.getRequestDispatcher("/view/admin/Session/SessionList.jsp").forward(request, response);
    } 
