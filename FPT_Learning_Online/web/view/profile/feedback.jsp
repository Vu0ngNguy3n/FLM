<%-- 
    Document   : feedback
    Created on : Feb 6, 2023, 11:03:02 AM
    Author     : Admin
--%>
                        ...
                        <div class="row">
                            <div class="col-lg-5 col-md-5 m-b30">
                                <div class="bg-primary text-white contact-info-bx">
                                    ...
                                    <p>FPT University Learning Materials</p>
                                    <div class="widget widget_getintuch">	
                                        <ul>
                                            <li><i class="ti-location-pin"></i>Địa chỉ: Đất Thổ Cư Hòa Lạc, Km29 Đường Cao Tốc 08, Thạch Hoà, Thạch Thất, Hà Nội 10000</li>
                                            <li><i class="ti-mobile"></i>024 7300 5588</li>
                            ...
                            <div class="col-lg-7 col-md-7">
                                <form class="contact-bx ajax-form" action="http://educhamp.themetrades.com/demo/assets/script/contact.php">
                                    ...
                                    <div class="heading-bx left">
                                        <h2 class="title-head">Get In <span>Feedback</span></h2>
