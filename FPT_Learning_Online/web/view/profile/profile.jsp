<%-- 
    Document   : profile
    Created on : Feb 5, 2023, 10:50:54 PM
    Author     : Admin
--%>
                                    ...
                                    <div class="profile-bx text-center">
                                        ...
                                        <div class="profile-tabnav">
                                            <ul class="nav nav-tabs">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="#chnage-avatar"><i class="ti-bookmark-alt"></i>Change Avatar</a>
                                                </li>

                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="${pageContext.request.contextPath}/FLM/changepass"><i class="ti-lock"></i>Change Password</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-12 m-b30">
                                    <div class="profile-content-bx">
                                        <div class="tab-content">
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                                <input class="form-control" type="text" value="" name="fullName" disabled="">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Phone</label>
                                                            <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                                <input class="form-control" type="text" value="" name="phone" disabled="">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Address</label>
                                                            <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                                <input class="form-control" type="text" value="" name="address" disabled="">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                                <input class="form-control" type="radio" value="" name="gender" disabled="">
                                                                <input class="form-control" type="radio" value="" name="gender" disabled="">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                                <input class="form-control" type="text" value="" name="birthday" disabled="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
                                                ...
                                                <form class="edit-profile">
                                                    <div class="">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Gender</label>
                                                            <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                                <input class="form-control" type="radio" value="" name="gender">
                                                                <input class="form-control" type="radio" value="" name="gender">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                            ...
                                            <div class="tab-pane" id="chnage-avatar">
                                                <div class="profile-head">
                                                    <h3>Change Avatar</h3>
                                                </div>
