                    ...
                    <div class="col-lg-12 m-b30">
                        <div class="widget-box">
                            <div class="widget-inner">
                                <form class="edit-profile m-b30" action="${pageContext.request.contextPath}/FLM/combochange" method="post">
                                    <div class="row">
                                        <input type="hidden" name="comboId" value="${requestScope.combo.comboid}">
                                        <input type="hidden" name="status" value="${requestScope.status}">
                                        <div class="form-group col-6">
                                            <label class="col-form-label">Combo Name <i style="color: red">*</i></label>
                                            <div>
                                                <input class="form-control" type="text" name="comboName" id="name" onchange="onSubmit(event)" value="${requestScope.combo.comboNameVn}" placeholder="Enter Combo Name...">
                                            </div>
                                        </div>
                                        <div class="form-group col-6">
                                            <label class="col-form-label">Note</label>
                                            <div>
                                                <input class="form-control" type="text" name="note" value="${requestScope.combo.note}" placeholder="Enter Note...">
                                            </div>
                                        </div>
                                                ...
                                                <select class="select"  data-mdb-filter="true" name="curriculum" >
                                                    <c:forEach items="${requestScope.curriculums}" var="curriculum">
                                                        <option value="${curriculum.curriculumId}" 
                                                                <c:if test="${curriculum.curriculumId eq requestScope.combo.curriculumId}">
                                                                    selected=""
                                                                </c:if>
                                                ...
                                                <select class="select" multiple data-mdb-filter="true" name="subjects">
                                                    <c:forEach items="${requestScope.subjects}" var="subject">
                                                        <option value="${subject.subjectCode}" 
                                                                <c:forEach items="${requestScope.combo.subjects}" var="subjects">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <button type="button" class="btn" data-toggle="modal" data-target="#exampleModal" style="background-color: orange"
                                                    <c:if test="${requestScope.status eq 1}">
                                                        <i class="fa-solid fa-plus mr-1"></i>Add Combo
                                                    </c:if>
                                                    <c:if test="${requestScope.status eq 0}">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <c:if test="${requestScope.status eq 1}">
                                                                Add new Combo: <i id="results"></i>
                                                            </c:if>
                                                            <c:if test="${requestScope.status eq 0}">
                                                                Change information of Combo: ${requestScope.combo.comboNameVn}
                                                            </c:if>
                                                        </div>
