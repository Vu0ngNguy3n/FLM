 ...
 * @author phanh
 */
@WebServlet(name = "DecisionListController", urlPatterns = {"/FLM/decisionList"})
public class DecisionListController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Decision> list = dao.getAll();

        int page, numberPerPage = 15;
        int size;
        if (list.isEmpty()) {
            size = 0;
        } else {
        ...
        List<Decision> listByPage = dao.getListByPage(list, start, end);
        ...
        request.getRequestDispatcher("/view/admin/decision/list.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (keysearch != null && !keysearch.isEmpty()) {
            list = dao.getDecisionByKey(keysearch);
            ...
            switch (sort) {
                case "id_asc":
                    Collections.sort(list, (Decision o1, Decision o2) -> {
                        if (o1.getDecisionID() > o2.getDecisionID()) {
                            return 1;
                        }
                        return -1;
                    });
